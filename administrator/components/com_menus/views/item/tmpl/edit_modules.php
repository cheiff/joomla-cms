	...
	<table class="table table-striped">
		...
		<?php foreach ($this->modules as $i => &$module) : ?>
				...
				<?php  else : ?>
					<?php  $published = "nopub "; ?>
				<?php  endif; ?>
				<tr class="<?php echo $no;?> <?php echo $published;?>row<?php echo $i % 2;?>" id="tr-<?php echo $module->id; ?>" style="display:table-row">
				...
				<td id="published-<?php echo $module->id; ?>">
						<?php if ($module->published):?>
							<span class="label label-success">
								<?php echo JText::_('JYES'); ?>
							</span>
